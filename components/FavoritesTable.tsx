...
const FavoritesTable: React.FC<FavoritesTableProps> = ({
  ...
  const renderExpandedRow = (item: CalculatedVehicle) => {
    ...
    return (
      <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-4">
        ...
        <div>
          <h4 className="font-bold text-base mb-3 text-slate-900 dark:text-slate-100">
  ...
  const columns = [
    ...
    },
    {
      ...
      className: "font-medium text-x-text-primary",
    },
    {
      header: "Stock #",
      accessor: "stock" as const,
      className: "text-x-text-secondary",
    },
    {
      header: "Year",
    ...
    },
    {
      ...
      isNumeric: true,
      className: "text-right font-semibold text-x-blue",
      render: (item: CalculatedVehicle) => (
  ...
  return (
    <div className="my-8">
      ...
      <Table
        ...
        onRowClick={(key) => toggleRowExpansion(String(key))}

...
export const MoonIcon = ({ className = "w-5 h-5" }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M7.455 2.164A8.969 8.969 0 019.5 2c1.94 0 3.743.71 5.164 1.879A8.998 8.998 0 009.5 18c-3.13 0-5.83-1.6-7.336-3.92a.75.75 0 01.89-1.064A7.479 7.479 0 009.5 16.5c-1.48 0-2.84-.44-3.965-1.189a.75.75 0 01-.22-1.042 7.474 7.474 0 00-1.856-3.844.75.75 0 01.077-1.05 8.956 8.956 0 012.419-3.145z" clipRule="evenodd" />
    </svg>
);
export const ComputerDesktopIcon = ({ className = "w-5 h-5" }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M2 5a3 3 0 013-3h10a3 3 0 013 3v6a3 3 0 01-3 3H5a3 3 0 01-3-3V5zm3-1a1 1 0 00-1 1v6a1 1 0 001 1h10a1 1 0 001-1V5a1 1 0 00-1-1H5z" clipRule="evenodd" />
...
export const ClipboardDocumentIcon = ({ className = "w-6 h-6" }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.125 2.25h-4.5c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125v-9M10.125 2.25h.375a9 9 0 019 9v.375M10.125 2.25A3.375 3.375 0 0113.5 5.625v1.5c0 .621.504 1.125 1.125h1.5a3.375 3.375 0 013.375 3.375M9 15l2.25 2.25L15 12" />
    </svg>
);
...
export const WandIcon = ({ className = "w-5 h-5" }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
      ...
      <path fillRule="evenodd" d="M10 5.25a4.75 4.75 0 100 9.5 4.75 4.75 0 000-9.5zM6.75 10a3.25 3.25 0 116.5 0 3.25 3.25 0 01-6.5 0z" clipRule="evenodd" />
    </svg>
);

...
// Redundant calculators removed (ReserveCalculator, FlatCalculator, TermComparator, PaymentCalculator, AffordabilityCalculator)
// These are now handled by the unified FinanceTools component.

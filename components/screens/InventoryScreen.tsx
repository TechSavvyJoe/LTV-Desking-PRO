...
/**
 * Inventory screen — sub-header per the INVENTORY block of
 * LTV Desking PRO.dc.html; body is a placeholder until the full 9-col sortable
 * grid ships in wave 2. [dc-redesign]
 */
export const InventoryScreen: React.FC = () => {
  const { inventory } = useDealContext();
  return (
    <div>
      <header
        style={{
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <span style={{ fontSize: 15, fontWeight: 600 }}>{inventory.length} units</span>

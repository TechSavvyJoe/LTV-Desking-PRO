...
/**
 * Pipeline screen — sub-header per the PIPELINE block of
 * LTV Desking PRO.dc.html; body is a placeholder until the KPI cards +
 * expandable rows ship in wave 2. [dc-redesign]
 */
export const PipelineScreen: React.FC = () => {
  const { savedDeals } = useDealContext();
  return (
    <div>
      <header
        style={{
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <span style={{ fontSize: 15, fontWeight: 600 }}>{savedDeals.length} working deals</span>
        </div>
      </header>
